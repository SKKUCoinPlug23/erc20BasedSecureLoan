...
/**
* @title LendingBoardConfigurator contract
* @author Aave
* @notice Executes configuration methods on the LendingBoardCore contract. Allows to enable/disable reserves,
* and set different protocol parameters.
**/

contract LendingBoardConfigurator is VersionedInitializable {
    ...
    **/
    ...
    LendingBoardAddressesProvider public boardAddressesProvider;
    /**
    * @dev only the lending pool manager can call functions affected by this modifier
    **/
    modifier onlyLendingBoardManager {
        require(
            boardAddressesProvider.getLendingBoardManager() == msg.sender,
    ...
    function initialize(LendingBoardAddressesProvider _boardAddressesProvider) public initializer {
        boardAddressesProvider = _boardAddressesProvider;
    }
    ...
    **/
    function initReserve(
        ...
        address _interestRateStrategyAddress
    ) external onlyLendingBoardManager {
    ...
    **/
    function initReserveWithData(
        ...
        uint8 _underlyingAssetDecimals,
        address _interestRateStrategyAddress
    ) public onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());

        AToken aTokenInstance = new AToken(
            boardAddressesProvider,
            _reserve,
            _underlyingAssetDecimals,
            _aTokenName,
            _aTokenSymbol
    ...
    **/
    function removeLastAddedReserve( address _reserveToRemove) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function disableBorrowingOnReserve(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function disableReserveAsCollateral(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function enableReserveStableBorrowRate(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function disableReserveStableBorrowRate(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function activateReserve(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function deactivateReserve(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function freezeReserve(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    * @param _reserve the address of the reserve
    **/
    function unfreezeReserve(address _reserve) external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
    ...
    **/
    function refreshLendingBoardCoreConfiguration() external onlyLendingBoardManager {
        LendingBoardCore core = LendingBoardCore(boardAddressesProvider.getLendingBoardCore());
