...
contract FeeProvider is IFeeProvider, VersionedInitializable {
    ...
    **/
    function calculateLoanOriginationFee(address _user, uint256 _amount) override external view returns (uint256) {
    ...
    **/
    function getLoanOriginationFeePercentage() override external view returns (uint256) {
