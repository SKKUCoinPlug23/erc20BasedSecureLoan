...
library CoreLibrary {
    ...
    **/
    function increaseTotalBorrowsStableAndUpdateAverageRate(
        ...
        _reserve.currentAverageStableBorrowRate = (weightedLastBorrow + weightedPreviousTotalBorrows).rayDiv(_reserve.totalBorrowsStable.wadToRay());
    }
    ...
    **/
    function decreaseTotalBorrowsStableAndUpdateAverageRate(
        ...
        //     .rayDiv(_reserve.totalBorrowsStable.wadToRay());
        _reserve.currentAverageStableBorrowRate = (weightedPreviousTotalBorrows - weightedLastBorrow).rayDiv(_reserve.totalBorrowsStable.wadToRay());
    }
